...
const UndercoverWin: React.FC<props> = ({navigateTo}) => {
  ...
  return (
    <div className="absolute w-[20rem] h-[27rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-40 border-[3px] border-white bg-[#E9E8E4] rounded-2xl py-8 px-10 flex flex-col items-center justify-between">
      <div className="">
        <h2 className="text-xl font-extrabold">Undercovers have won!</h2>
      </div>

      <div className="">
                <img src="https://images.squarespace-cdn.com/content/v1/6166cfc7f0f9c96fd146e6ca/1634503987177-FNP01OKKAEETWEU0VXU0/underover+role" alt="" />
